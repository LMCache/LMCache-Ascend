...
class HcclAgentWrapper:
    ...
    def __init__(
        ...
        # HCCL Doesn't allow the host registering a host pointer twice. We could register the corresponding 
        # device pointer, however this limits the registereable memory to the device capacity.
        ...
        if already_registered: # Re register memory to make it accessible by lmc_ops kernerls
