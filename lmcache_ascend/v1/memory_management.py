...
class KVCacheFormat(Enum):
    """
    The storage format enumeration of KV cache is used to distinguish the KV cache data structures of different versions of vLLM.
    """
    ...
    @staticmethod
    def detect(kvcaches) -> 'KVCacheFormat':
        if not kvcaches:
