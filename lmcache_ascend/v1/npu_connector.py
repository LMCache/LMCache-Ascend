...
class KVCacheFormat(Enum):
    ...
    def detect(
        ...
        if isinstance(first_cache, tuple):
            ...
            # MLA detect 
            # MLA Shape is either (num_blocks, block_size, head_size) or (1, num_blocks, block_size, head_size)
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if is_310p():
            ...
            assert "head_size" in kwargs, (
                "head_size should be provided in 310p",
            )
