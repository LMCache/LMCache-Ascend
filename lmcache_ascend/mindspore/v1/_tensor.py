"""
    This file contain methods that can be used to get information about a torch.Tensor or np.ndarray.
"""
import torch
import numpy as np
...
def view_and_shape(tensor: Union[torch.Tensor, np.ndarray], dtype: torch.dtype, shape: torch.Size):
