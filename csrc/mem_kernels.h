...
void fused_multi_layer_kv_transfer(torch::Tensor& key_value,
...
void batched_fused_single_layer_kv_transfer(std::vector<torch::Tensor>& lmc_tensors,
                                            torch::Tensor& staging_cache,
                                            torch::Tensor& vllm_key_value_cache,
                                            torch::Tensor& slot_mapping_full,
